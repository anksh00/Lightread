...
<body style="margin: 0px">
	<div style="width: 100%; height: 50px;">
		...
		<div
		 ...
		 <div
			style="width: 100%; height: 520px; background-color:gold; float: left;">
		 
		 <h1 style="margin-left: 250px;margin-top: 80px;margin-right: 20px"><b>We are sorry for the uncertainty. Till now CSE- 3rd year 6th semester hand written notes and quantum have been released and
			  We are trying our best to release all the branch hand written notes and quantum as soon as possible.</b></h1> 
			 
			 <h3 style="background-color: white;margin-left: 250px">If you want to help us, you can e-mail your branch's best notes on this email Id--<a href="https://mail.google.com/mail/u/0/">lightreadhelp@gmail.com</a></h3>
		 </div>
